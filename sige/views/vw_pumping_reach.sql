...
CREATE OR REPLACE VIEW qgep_sige.vw_pumping_reach
 AS
...
ALTER TABLE qgep_sige.vw_pumping_reach
    OWNER TO sige;


-- Rule: vw_pumping_reach_on_update ON qgep_sige.vw_pumping_reach

-- DROP Rule IF EXISTS vw_pumping_reach_on_update ON qgep_sige.vw_pumping_reach;

CREATE RULE vw_pumping_reach_on_update AS
    ON UPDATE TO qgep_sige.vw_pumping_reach
    DO INSTEAD
